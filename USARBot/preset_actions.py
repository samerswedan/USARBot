...
def walk_forward(spider):
    spider.do_action('forward',1, speed=80)
    
def walk_backward(spider):
    spider.do_action('backward',1, speed=80)
    
def turn_right(spider):
    spider.do_action('turn right',2, speed=80)
    
def turn_left(spider):
    spider.do_action('turn left',2, speed=80)
